...
class warmup_scheduler(object):
    def __init__(self, iter_per_epoch, max_epoch, warmup_epoch=5):
        """Sets a StepLR or CosineLR learning rate schedule with warmup.
        Args:
            iter_per_epoch (int): Number of iterations per epoch.
            max_epoch (int): Total number of epochs including the epochs for warmup.
            warmup_epoch (int): Number of epochs for warmup.
        """
