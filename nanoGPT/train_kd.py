...
# optimizer
optimizer_sgd, optimizer_adamw = model.configure_optimizers(weight_decay, learning_rate, (beta1, beta2), device_type)
if init_from == 'resume':
    optimizer_sgd.load_state_dict(checkpoint['optimizer'])
    optimizer_adamw.load_state_dict(checkpoint['optimizer'])
        ...
        if losses['val'] < best_val_loss or always_save_checkpoint:
            ...
            if iter_num > 0:
                checkpoint = {
                    ...
                    'optimizer': {'SGD': optimizer_sgd.state_dict(), 'AdamW': optimizer_adamw.state_dict()},
